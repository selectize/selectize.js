...
$.extend(Selectize.prototype, {
    ...
    setup: function () {
        ...
        $wrapper = $("<div>")
            ...
            .addClass(inputMode);
        $control = $("<div>")
            .addClass(settings.inputClass + noArrowClass + " selectize-input items")
            .appendTo($wrapper);
        $control_input = $('<input type="text" autocomplete="off" autofill="no" />')
            .appendTo($control)
        ...
        $document.on("mousedown" + eventNS, function (e) {
            if (self.isFocused) {
                ...
                if (e.target === self.$dropdown[0] || self.$dropdown.has(e.target).length) {
                    return false;
                }
